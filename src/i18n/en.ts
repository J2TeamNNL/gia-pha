...
export const en: Dictionary = {
  ...
  form: {
    ...
    fullName: "Full name",
    fullNamePlaceholder: "e.g. Nguyễn Văn An",
    splitAs: "Split as",
    editSplit: "Edit how the name splits",
    hideSplit: "Hide",
    birthYear: "Birth year",
    birthYearPlaceholder: "e.g. 1950",
    deceased: "Deceased",
    deathYear: "Death year",
    saveAndClose: "Save and close",
    shortcutHint: "Ctrl + Enter saves and starts the next person",
  ...
  paste: {
    ...
    insertSample: "Insert a worked example",
    clear: "Clear",
